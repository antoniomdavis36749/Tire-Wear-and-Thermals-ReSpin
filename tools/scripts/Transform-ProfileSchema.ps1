...
$path = 'C:\Users\anton\AppData\Local\BeamNG\BeamNG.drive\current\mods\unpacked\tyre-thermals-and-wear\lua\vehicle\extensions\auto\luukstyrethermalsandwear.lua'
